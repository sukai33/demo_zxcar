...
if("TRUE" STREQUAL "TRUE")
  set(allians_arbotix_SOURCE_PREFIX /home/sk/workspas/demo_zxcar/src/allians_arbotix)
  set(allians_arbotix_DEVEL_PREFIX /home/sk/workspas/demo_zxcar/devel)
  ...
  set(allians_arbotix_INSTALL_PREFIX /home/sk/workspas/demo_zxcar/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'allians_arbotix' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sk/workspas/demo_zxcar/src/allians_arbotix/${idir}'.  ${_report}")
    endif()
